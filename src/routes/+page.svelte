...
<div class="absolute transform-gpu blur-[68px] pointer-events-none" aria-hidden="true">
  ...
  <div class="container flex flex-col px-6 py-4 mx-auto space-y-6 md:h-128 md:py-16 md:flex-row md:items-center md:space-x-6">
      <div class="flex flex-col items-center w-full md:flex-row md:w-1/2">
          ...
          <div class="max-w-2xl md:mx-12 md:order-2">
              <h1 class="text-[72px] font-extrabold text-[#0F172A] md:text-[60px]"> <span class="bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 text-transparent bg-clip-text">Remove Background</span> From Images For Free</h1>
              <p class="mt-4 text-[#94A3B8] text-lg">Introducing CaptureQuest, a platform designed to help you create stunning visuals,
                promote your product, and enhance your images.
                
                </p>
              <div class="mt-6">
                  <a href="#" class="block px-3 py-2 font-semibold text-center duration-200   rounded-md md:inline text-white bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500  hover:from-pink-500 hover:to-yellow-500  cursor-pointer">Try For Free</a>
              </div>
          </div>
      </div>
  ...
  <div class="flex justify-center mt-20  ">
    <iframe class="flex justify-center w-[450px] h-[250px] rounded-3xl lg:w-[768px] lg:h-[548px] md:w-[768px] md:h-[548px] sm:w-[724px] sm:h-[400px]  "   width="768" height="548" src="https://www.youtube.com/embed/2vWh2kaeZkI?si=XvKXPSJfLdLSlo_t" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
  </div>
      </div>
  </div>
</div>
    ...
    <div class="flex flex-col mt-36 py-4">
      ...
      >
        ...
        <button class="inline-block px-16 py-2 my-4 rounded-full font-semibold text-lg text-white bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500  hover:from-pink-500 hover:to-yellow-500  cursor-pointer">
          Upload Image
        </button>
        {#if value.length === 0}
      ...
      <div class="  ">
        <div id="Feautres" class="flex justify-center scroll-smooth  text-black font-bold text-[60px] md:text-[48px] mt-20">
          <h1>Uncover Something hidden</h1>
        </div>
...
<div class="flex flex-col lg:flex-row items-center mt-24 justify-center pb-24 pt-11">
  <div id="howtouse" class="container mx-auto px-6">
    <h1 class="text-2xl lg:text-[60px] font-bold mb-14 text-center">Let's Get Started</h1>
...
<div id="faq" class="max-w-screen-xl mx-auto px-5 ">
  <div class="flex flex-col items-center ">
    <h2 class="font-bold text-black text-5xl  tracking-tight">
      FAQ
    </h2>
