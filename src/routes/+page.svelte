  ...
  <div class="container flex flex-col px-6 py-4 mx-auto space-y-6 md:h-128 md:py-16 md:flex-row md:items-center md:space-x-6">
    <div class="flex flex-col items-center w-full md:flex-row md:w-[60%]">
      <div class="max-w-2xl md:mx-12 md:order-2">
        <h1 class="text-[36px] md:text-[48px] lg:text-[60px] font-extrabold text-[#0F172A]">
          <span class="bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 text-transparent bg-clip-text text-[36px] md:text-[48px] lg:text-[60px]">Remove Background</span> From Images For Free
        </h1>
        <p class="mt-4 text-[#94A3B8] text-lg">
          Introducing CaptureQuest, a platform designed to help you create stunning visuals, promote your product, and enhance your images.
        </p>
        <div class="mt-6 flex justify-center md:justify-start">
          <a href="#" class="px-3 py-2 font-semibold text-center duration-200 rounded-md md:inline text-white bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 hover:from-pink-500 hover:to-yellow-500 cursor-pointer">Try For Free</a>
        </div>
      </div>
    </div>

    <div class="max-w-3xl h-[300px] md:h-[400px] lg:h-[450px] w-full relative mx-auto md:w-[40%]">
...
<div class="flex flex-col mt-11 py-4">
  <h1 class="text-center font-bold py-3 text-[30px] lg:text-[60px]">Screenshot Background Removal</h1>
  <Dropzone
    id="dropzone"
    on:drop={dropHandle}
    on:dragover={(event) => {
  ...
  >
    ...
    <button class="inline-block px-8 md:px-16 py-2 my-4 rounded-full font-semibold text-lg text-white bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 hover:from-pink-500 hover:to-yellow-500 cursor-pointer">
  ...
  <div id="Feautres" class="flex flex-col md:flex-row mx-auto justify-center py-6">
    {#if imageUrl}
    ...
    {#if processedImage}
      <div class="flex flex-col items-center md:ml-4">
        ...
        <button class="mt-4" on:click={downloadImage}>Download Processed Image</button>
      </div>
    {/if}
  </div>
</div>
        ...
        <div>
          <div class="flex justify-center  text-black font-bold text-[32px] md:text-[48px] mt-20">
...
<div  class="flex flex-col lg:flex-row items-center mt-24 justify-center pb-24 pt-11">
  <div  class="container mx-auto px-6">
    <h1 class="text-[30px] lg:text-[60px] font-bold mb-14 text-center">Let's Get Started</h1>
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-10 px-6 sm:px-8 max-w-[1200px] w-full mx-auto mb-8">
      ...
      <a href="/app" class="box group bg-gray-100 rounded-lg p-4 shadow-lg space-y-3 flex flex-col transition-transform duration-300 hover:translate-y-[-10px] hover:shadow-indigo-500/40 cursor-pointer">
        ...
        <p class="text-[16px] text-[#64748B]">CaptureQuest runs 100% locally in your browser. We only keep your Images on our server when you save it.
        </p>
      ...
      <a href="/app" class="box group bg-gray-100 rounded-lg p-4 shadow-lg space-y-3 flex flex-col transition-transform duration-300 hover:translate-y-[-10px] hover:shadow-indigo-500/40 cursor-pointer">
        ...
        <p class="text-[16px] text-[#64748B]">Share* directly on your socials</p>
      ...
      <button  class=" px-16 py-2 my-4 rounded-full font-semibold text-lg text-white bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500  hover:from-pink-500 hover:to-yellow-500  cursor-pointer">
        Upload Image
      </button>
...
<div id="pricing" class="h-full scroll-smooth w-full relative">
  <div class="relative flex-col flex gap-5 text-center py-24 font-bold text-3xl sm:text-4xl md:text-5xl lg:text-6xl">
    <p class="text-indigo-500 font-bold text-[16px] mb-8">
      Pricing
    </p>
  ...
  <div class="flex flex-col lg:flex-row gap-8 mx-auto">
    <div class="grid grid-cols-1 md:grid-cols-2 gap-8 mx-auto py-14">
      <Card class="h-fit relative border-indigo-500 border-2 " padding="xl">
        ...
        <form action="?/subscribepro" class="flex flex-row  justify-center" method="POST">
           
            <button class="px-32 rounded-xl py-2 text-white text-nowrap bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500  hover:from-pink-500 hover:to-yellow-500  cursor-pointer">Get Started</button>
      ...
      <Card class="h-fit" padding="xl">
        ...
        <form action="?/subscribepro" method="POST" class="flex flex-row  justify-center">
          <button class="px-32 rounded-xl py-2 text-white text-nowrap bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500  hover:from-pink-500 hover:to-yellow-500  cursor-pointer" type="submit">Get Started</button>
        </form>
...
<div id="faq"  class="max-w-screen-xl mx-auto px-5 ">
  <div class="flex flex-col items-center  ">
    <h2 class="font-bold text-black text-5xl mt-44   tracking-tight">
      FAQ
    </h2>
  ...
  <div class="grid divide-y divide-neutral-200 mb-11 max-w-xl mx-auto mt-8"> 
    <div class="py-5">
      <details class="group">
        <summary class="flex justify-between items-center text-black font-medium cursor-pointer list-none" on:click={toggleTextColor}>
    ...
    <div class="py-5">
      <details class="group">
        <summary class="flex text-black justify-between items-center font-medium cursor-pointer list-none" on:click={toggleTextColor}>
